...
@XmlRootElement(name = "createAutorResponse")
public class CreateAutorResponse {

    @XmlElement(required = true)
    protected pe.edu.cibertec.DSWI_CL1_GRUPO4.model.Autor autor;
     ...
     * {@link Autor }
     */
    public pe.edu.cibertec.DSWI_CL1_GRUPO4.model.Autor getAutor() {
        return autor;
    }
